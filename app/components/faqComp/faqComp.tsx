...
const FAQComp: React.FC = () => {
  ...
  return (
    <section className="relative h-fit py-12 bg-[#f7f7f6] rounded-3xl w-[100rem] overflow-hidden">
      <img src="/Resource/Vector (1).svg" alt="" className="absolute -z-1 top-0 left-[35%] w-fit" />
      <img src="/Resource/Lines group.svg" alt="" className="absolute top-4 -z-1 left-2 w-28 z-10" />
