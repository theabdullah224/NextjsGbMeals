...
import leftarrow from '../../../public/Resource/leftarrow.svg';
import rightarrow from '../../../public/Resource/rightarrow.svg';
// import slide1 from './Resource/adjusted without img 1.png';
import slide1 from '../../../public/Resource/adjusted without img 1.png';
import slide2 from '../../../public/Resource/without img 2.png';
import slide3 from '../../../public/Resource/without img 3.png';
import slide4 from '../../../public/Resource/without img 4.png';
  ...
  return (
    ...
    <div className="h-fit w-screen px-4 sm:px-9 font-roboto bg-white">
      ...
      <div className="sm:hidden block mb-6">
        <h1 className="text-2xl 2xl:text-5xl font-bold text-Text1 mb-6 mt-6">
      ...
      <div className="relative h-full rounded-3xl overflow-hidden">
        ...
        >
          <Image src={leftarrow} alt="" className="w-2 sm:w-6" />
        </button>
        ...
        >
          <Image src={rightarrow} alt="" className="w-2 sm:w-6" />
        </button>
      </div>
    </div>
  );
